...
const AdminDashboardScreen = ({ navigation }) => {
    const ADMIN_ACTIONS = [
        {
            id: 'notices',
            title: 'Notices',
            subtitle: 'Send global broadcast alert',
            icon: 'megaphone',
            color: '#6366F1',
            bg: '#EEF2FF'
        },
        {
            id: 'complaints',
            title: 'Complaints',
            subtitle: '12 pending resolution today',
            icon: 'warning',
            color: '#EF4444',
            bg: '#FEF2F2'
        },
        {
            id: 'lostfound',
            title: 'Lost & Found',
            subtitle: '84 items logged this semester',
            icon: 'search',
            color: '#3B82F6',
            bg: '#EFF6FF'
        },
        ...
        },
        {
            id: 'clubs',
            title: 'Clubs',
            subtitle: '42 active student organizations',
            icon: 'people',
            color: '#F59E0B',
            bg: '#FFFBEB'
        }
    ...
    const handlePress = (id) => {
        if (id === 'events') {
            ...
            // Placeholder for other management screens
